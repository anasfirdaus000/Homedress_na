...
const PRODUCTS = [
  ...
  },
  {
    ...
    social_proof: 'Best Seller — Ramah Busui',
    related_ids: ['tasya-set-cargo', 'fuji-oneset-blaster', 'setelan-santai-mint-premium']
  },
  {
    slug: 'tasya-set-cargo',
    ...
    social_proof: 'Hot Item 🔥 Outfit Daily',
    related_ids: ['naila-set-vol2', 'fuji-oneset-blaster', 'setelan-hitam-olahraga-santai']
  },
  {
    slug: 'fuji-oneset-blaster',
    ...
    social_proof: 'Viral di TikTok ✨',
    related_ids: ['tasya-set-cargo', 'naila-set-vol2', 'celana-pendek-santai']
  }
];
